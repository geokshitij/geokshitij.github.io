...
personal_info = {
    ...
    "education": [
        {"degree": "PhD, Civil, Environmental and Sustainable Engineering", "university": "Arizona State University, Arizona, USA", "period": "Dec 2022 – May 2026"},
    ...
    "employment": [
        {"role": "Postdoctoral Researcher", "institution": "The University of Kansas, Lawrence, KS, USA", "period": "May 2026 – Present"},
        {"role": "Graduate Research Associate", "institution": "Arizona State University, Arizona, USA", "period": "Dec 2022 – May 2026"},
...
publications_data = [
    ...
    {"title": "Ensemble streamflow forecasting with diverse loss functions", "venue": "Applied Soft Computing", "date": "2026-01-01", "paperurl": "https://www.sciencedirect.com/science/article/abs/pii/S1568494626007246", "citation": "<strong>Dahal, K.</strong>, Gupta, A., Bokati, L. & Kumar, S.* (2026). &quot;Ensemble streamflow forecasting with diverse loss functions.&quot; <i>Applied Soft Computing</i>."},
...
Reliable water prediction underpins both supply and safety. I develop machine learning and physics-based methods that improve the accuracy of streamflow forecasts and quantify their uncertainty, and I use explainable AI to make sense of groundwater and hydrologic processes where data are scarce. Much of the streamflow work targets the arid basins of the US Southwest. Selected work: explainable AI for groundwater potential in data-scarce regions ([Dahal et al., 2023](https://doi.org/10.1016/j.jhydrol.2023.130417)); ensemble streamflow forecasting with diverse loss functions ([Dahal et al., 2026](https://www.sciencedirect.com/science/article/abs/pii/S1568494626007246)).

### 2. Hazards and infrastructure risk
Water-driven hazards cascade: rainfall triggers landslides that block rivers that flood the towns and infrastructure downstream. I map and forecast these cascading hazards and the exposure of critical infrastructure, so communities can see the risk before it arrives. Selected work: cascading-hazard characterization on mountain terrain ([Talchabhadel et al., 2023](https://doi.org/10.1080/19475705.2022.2162443)); rainfall-triggered landslide zonation for critical infrastructure ([Gnyawali et al., 2023](https://doi.org/10.1016/j.scitotenv.2023.162242)); flood-exposure assessment for schools ([Bishui et al., 2026](https://link.springer.com/article/10.1007/s11069-025-07852-6)).

### 3. Sustainable development
Beyond mitigation, the pressing question is development: clean water, food, infrastructure, and livelihoods. I use earth observation and machine learning to inform that agenda with evidence. Selected work: carbon and biodiversity stakes of climate-driven wildfires ([Dahal et al., 2025](https://doi.org/10.1016/j.infgeo.2025.100003)); urban agriculture as a sustainability lever ([Pradhan et al., 2024](https://doi.org/10.1016/j.crsus.2024.100217)); IPCC science applied to the SDG agenda ([Pradhan et al., 2025](https://doi.org/10.1016/j.resenv.2025.100192)).
...
<a href="https://docs.google.com/document/d/1Mndv6ZTSUXTpm0GEMDLeL1c7mdpGmSMvqs4Vk6foDeA/edit?usp=sharing" class="btn btn--primary" target="_blank">Open in Google Docs</a>
</p>
